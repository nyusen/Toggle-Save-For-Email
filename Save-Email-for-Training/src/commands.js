...
const config = {
    clientId: "	9bc9d68e-7b66-4b36-ba58-9542005bf215",
        ...
        generateCodeChallenge(codeVerifier)
            .then((codeChallenge) => {
                ...
                setTimeout(() => {
                    ...
                    Office.context.ui.displayDialogAsync(startUrl.toString(), { height: 60, width: 30 }, function (result) {
        ...
        Office.context.mailbox.item.loadCustomPropertiesAsync(async (result) => {
            ...
            if (!accessToken) {
                ...
                Office.context.ui.displayDialogAsync(
                    "https://ml-inf-svc-dev.eventellect.com/outlook-save-for-training/signin-dialog.html",
...
async function saveForTraining(event) {
    ...
    item.loadCustomPropertiesAsync(async (result) => {
        try {
            ...
            Office.context.ui.displayDialogAsync(
                `https://ml-inf-svc-dev.eventellect.com/outlook-save-for-training/retry-dialog.html?error=${errorMessage}`,
